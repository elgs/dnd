...
const baseUrl = 'http://127.0.0.1:' + port + '/examples';
...
describe('droppable tests', () => {
   ...
   it('should drop to small target', async () => {
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('');
      expect(await getText(page, '.target-large.target .message')).toBe('');

      await page.mouse.move(start.x + 1, start.y, { steps: 10 });
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('touch_in');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('target_center_in');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('source_center_in');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('pointer_in');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('target_all_in');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');
      ...
      await page.mouse.move(start.x + gap + sourceSize + 2, start.y, { steps: 10 });
      expect(await getText(page, '.target-small.target .message')).toBe('target_all_out');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('source_center_out');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');

      await page.mouse.move(start.x + gap + smallTargetSize + 60, start.y, { steps: 10 });
      expect(await getText(page, '.target-small.target .message')).toBe('pointer_out');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('target_center_out');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('touch_out');
      expect(await getText(page, '.target-large.target .message')).toBe('dragged');

      await page.mouse.up();
      expect(await getText(page, '.target-small.target .message')).toBe('dropped');
      expect(await getText(page, '.target-large.target .message')).toBe('dropped');
   });
   ...
   it('should drop to large target', async () => {
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('touch_in');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('source_center_in');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('pointer_in');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('target_center_in');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('source_all_in');
      ...
      await page.mouse.move(start.x + gap * 2 + smallTargetSize + largeTargetSize + 2, start.y, { steps: 10 });
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('source_all_out');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('target_center_out');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('source_center_out');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('pointer_out');
      ...
      expect(await getText(page, '.target-small.target .message')).toBe('dragged');
      expect(await getText(page, '.target-large.target .message')).toBe('touch_out');
