import { getDocScrollLeft, getDocScrollTop, getHeight, getWidth, index, isOutside, isTouchDevice, matches, normalizeIcon, parseDOMElement, resolveFunction, cursor } from './lib.js';

import { makeRightClick } from './az.js';
...
export class ContextMenu {
   ...
   init() {
      ...
      me.rightClick = makeRightClick(dom, {
