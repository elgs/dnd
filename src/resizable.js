import { getHeight, getWidth, normalizeIcon, setHeight, setOuterBorderHeight, setOuterBorderWidth, setWidth } from './lib.js';
import { makeDraggable } from './az.js';
...
export class Resizable {
   ...
   _resetHandles() {
      ...
      if (me.handles.ne) {
         ...
         me.handles.ne.style['width'] = cornerSize + 'px';
         me.handles.ne.style['height'] = cornerSize + 'px';
         me.handles.ne.style['z-index'] = Number.MAX_SAFE_INTEGER;
         me.handles.ne.style['opacity'] = 0;
      }
      if (me.handles.se) {
         ...
         me.handles.se.style['width'] = cornerSize + 'px';
         me.handles.se.style['height'] = cornerSize + 'px';
         me.handles.se.style['z-index'] = Number.MAX_SAFE_INTEGER;
         me.handles.se.style['opacity'] = 0;
      }
      if (me.handles.sw) {
         ...
         me.handles.sw.style['width'] = cornerSize + 'px';
         me.handles.sw.style['height'] = cornerSize + 'px';
         me.handles.sw.style['z-index'] = Number.MAX_SAFE_INTEGER;
         me.handles.sw.style['opacity'] = 0;
      }
      if (me.handles.nw) {
         ...
         me.handles.nw.style['width'] = cornerSize + 'px';
         me.handles.nw.style['height'] = cornerSize + 'px';
         me.handles.nw.style['z-index'] = Number.MAX_SAFE_INTEGER;
         me.handles.nw.style['opacity'] = 0;
      }
   }
}
